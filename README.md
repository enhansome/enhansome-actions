...
* [Official Actions organization](https://github.com/actions)
  * [actions/virtual-environments](https://github.com/actions/virtual-environments) ⭐ 13,121 | 🐛 129 | 🌐 PowerShell | 📅 2026-09-09 - GitHub Actions virtual environments.
  * [actions/runner](https://github.com/actions/runner) ⭐ 6,246 | 🐛 528 | 🌐 C# | 📅 2026-09-09 - The Runner for GitHub Actions.
* [GitHub Blog Announcement](https://github.blog/2018-10-17-action-demos/)

### Workflow Examples

* [actions/starter-workflows](https://github.com/actions/starter-workflows) ⭐ 12,032 | 🐛 507 | 🌐 TypeScript | 📅 2026-08-03 - Starter workflow management.
...
* [actions/checkout](https://github.com/actions/checkout) ⭐ 8,858 | 🐛 693 | 🌐 TypeScript | 📅 2026-09-03 - Setup your repository on your workflow.
* [actions/cache](https://github.com/actions/cache) ⭐ 5,544 | 🐛 240 | 🌐 TypeScript | 📅 2026-07-15 - Cache dependencies and build outputs in GitHub Actions.
* [actions/github-script](https://github.com/actions/github-script) ⭐ 5,018 | 🐛 93 | 🌐 TypeScript | 📅 2026-04-09 - Write a script for GitHub API and the workflow contexts.
* [actions/upload-artifact](https://github.com/actions/upload-artifact) ⭐ 4,191 | 🐛 262 | 🌐 TypeScript | 📅 2026-04-14 - Upload artifacts from your workflow.
* [actions/download-artifact](https://github.com/actions/download-artifact) ⭐ 1,896 | 🐛 155 | 🌐 TypeScript | 📅 2026-03-18 - Download artifacts from your build.

#### Actions for GitHub Automation

Automate management for issues, pull requests, and releases.

* [actions/labeler](https://github.com/actions/labeler) ⭐ 2,496 | 🐛 67 | 🌐 TypeScript | 📅 2026-09-03 - An action for automatically labelling pull requests.
* [actions/stale](https://github.com/actions/stale) ⭐ 1,707 | 🐛 94 | 🌐 TypeScript | 📅 2026-09-03 - Marks issues and pull requests that have not had recent interaction.
...
* [actions/first-interaction](https://github.com/actions/first-interaction) ⭐ 894 | 🐛 27 | 🌐 TypeScript | 📅 2026-01-21 - An action for filtering pull requests and issues from first-time contributors.
...
* [actions/delete-package-versions](https://github.com/actions/delete-package-versions) ⭐ 441 | 🐛 61 | 🌐 TypeScript | 📅 2025-06-06 - Delete versions of a package from GitHub Packages.

#### Setup Actions

Set up your GitHub Actions workflow with a specific version of your programming languages.

* [actions/setup-node: Node.js](https://github.com/actions/setup-node) ⭐ 4,955 | 🐛 77 | 🌐 TypeScript | 📅 2026-09-03
* [actions/setup-python: Python](https://github.com/actions/setup-python) ⭐ 2,218 | 🐛 58 | 🌐 TypeScript | 📅 2026-09-09
* [actions/setup-java: Java](https://github.com/actions/setup-java) ⭐ 2,005 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-09
* [actions/setup-go: Go](https://github.com/actions/setup-go) ⭐ 1,761 | 🐛 51 | 🌐 TypeScript | 📅 2026-09-08
* [actions/setup-dotnet: .NET core sdk](https://github.com/actions/setup-dotnet) ⭐ 1,205 | 🐛 38 | 🌐 TypeScript | 📅 2026-09-03
...
* [actions/setup-julia: Julia](https://github.com/julia-actions/setup-julia) ⭐ 107 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-04
...
* [actions/toolkit](https://github.com/actions/toolkit) ⭐ 5,846 | 🐛 589 | 🌐 TypeScript | 📅 2026-09-09 - The GitHub ToolKit for developing GitHub Actions.
* [actions/typescript-action](https://github.com/actions/typescript-action) ⭐ 2,415 | 🐛 22 | 🌐 TypeScript | 📅 2026-07-20 - Create a TypeScript Action.
* [actions/javascript-action](https://github.com/actions/javascript-action) ⭐ 1,188 | 🐛 16 | 🌐 JavaScript | 📅 2026-07-28 - Create a JavaScript Action.
...
* [actions/hello-world-docker-action](https://github.com/actions/hello-world-docker-action) ⭐ 180 | 🐛 2 | 🌐 Dockerfile | 📅 2026-03-09 - A template to demonstrate how to build a Docker action.
* [actions/container-toolkit-action](https://github.com/actions/container-toolkit-action) ⭐ 165 | 🐛 7 | 🌐 TypeScript | 📅 2026-06-22 - Template repo for creating container actions using actions/toolkit.

## Community Resources

### GitHub Tools and Management

* [Run GitHub Actions Locally in Terminal](https://github.com/nektos/act) ⭐ 71,854 | 🐛 378 | 🌐 Go | 📅 2026-08-09
* [Publish GitHub Releases with Assets](https://github.com/softprops/action-gh-release) ⭐ 5,759 | 🐛 116 | 🌐 TypeScript | 📅 2026-08-30
...
* [Publish a docker image to Dockerhub](https://github.com/elgohr/Publish-Docker-Github-Action) ⭐ 793 | 🐛 0 | 🌐 Shell | 📅 2026-09-09
* [Enforce Policies on GitHub Repositories and Commits](https://github.com/talos-systems/conform) ⭐ 524 | 🐛 8 | 🌐 Go | 📅 2026-09-05
* [Remove Old Artifacts](https://github.com/c-hive/gha-remove-artifacts) ⭐ 394 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-04
* [GitHub Project Automation+](https://github.com/alex-page/github-project-automation-plus) ⭐ 351 | 🐛 16 | 🌐 JavaScript | 📅 2024-01-03 - Automate GitHub Project cards with any webhook event.
* [Create Issue Branch](https://github.com/robvanderleek/create-issue-branch) ⭐ 350 | 🐛 10 | 🌐 JavaScript | 📅 2026-09-05
...
* [GitHub Codeowners Validator](https://github.com/mszostok/codeowners-validator) ⭐ 247 | 🐛 59 | 🌐 Go | 📅 2024-05-01 - Ensures the correctness of your GitHub CODEOWNERS file. It supports public and private GitHub repositories and also GitHub Enterprise installations.
* [Action to sync GitHub labels in the declarative way](https://github.com/micnncim/action-label-syncer) ⭐ 219 | 🐛 21 | 🌐 Go | 📅 2023-06-22
* [Add releases to GitHub](https://github.com/elgohr/Github-Release-Action) ⭐ 216 | 🐛 1 | 🌐 Shell | 📅 2026-08-21
* [Declaratively setup GitHub Labels](https://github.com/lannonbr/issue-label-manager-action) ⭐ 193 | 🐛 5 | 🌐 JavaScript | 📅 2022-11-25
* [Create an issue using content from a file](https://github.com/peter-evans/create-issue-from-file) ⭐ 177 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-03
* [Use private actions in any workflow](https://github.com/InVisionApp/private-action-loader) ⭐ 171 | 🐛 16 | 🌐 TypeScript | 📅 2024-02-15
* [Manage Labels on GitHub (create/rename/update/delete) as Code](https://github.com/crazy-max/ghaction-github-labeler) ⭐ 169 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-05
* [Get a list of file changes with PR/Push](https://github.com/trilom/file-changes-action) ⭐ 168 | 🐛 42 | 🌐 TypeScript | 📅 2023-03-15
* [Generate Release Notes Based on Git References](https://github.com/metcalfc/changelog-generator) ⭐ 149 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-08
...
* [Prow GitHub Actions](https://github.com/jpmcb/prow-github-actions) ⭐ 121 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-09 - Automation of policy enforcement, chat-ops, and automatic PR merging.
...
* [Create a GitHub wiki page based on the provided markdown file](https://github.com/Decathlon/wiki-page-creator-action) ⭐ 107 | 🐛 3 | 🌐 Shell | 📅 2022-03-28
...
* [Add Label to your Pull Requests based on the author team name](https://github.com/JulienKode/team-labeler-action) ⭐ 50 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-01
* [Expose Git Commit Data As Environment Variables](https://github.com/rlespinasse/git-commit-data-action) ⭐ 41 | 🐛 0 | 🌐 Shell | 📅 2026-08-30
* [Check GitHub Status in your Workflow](https://github.com/crazy-max/ghaction-github-status) ⭐ 40 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-05
...
* [GitHub Actions for PHP](https://github.com/shivammathur/setup-php) ⭐ 3,255 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-09
* [GitHub Actions for Flutter](https://github.com/subosito/flutter-action) ⭐ 2,606 | 🐛 24 | 🌐 Shell | 📅 2026-04-30
* [Use HashiCorp's Terraform](https://github.com/hashicorp/setup-terraform) ⭐ 1,583 | 🐛 73 | 🌐 JavaScript | 📅 2026-09-07
* [GitHub Actions for Unity](https://github.com/webbertakken/unity-actions) ⭐ 1,099 | 🐛 0 | 🌐 Mathematica | 📅 2023-03-04
* [GitHub Actions for WordPress](https://github.com/10up/actions-wordpress/) ⭐ 463 | 🐛 5 | 🌐 Shell | 📅 2025-10-09
* [GitHub Actions for Yarn 1](https://github.com/Borales/actions-yarn) ⭐ 315 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-09
...
* [GitHub Actions for AWS](https://github.com/clowdhaus/aws-github-actions) ⭐ 122 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-05
* [Octions - GitHub Actions for GitHub REST API](https://github.com/maxkomarychev/octions) ⭐ 43 | 🐛 17 | 🌐 JavaScript | 📅 2023-01-05
* [GitHub Actions for Composer](https://github.com/MilesChou/composer-action) ⭐ 33 | 🐛 2 | 🌐 Dockerfile | 📅 2026-09-04
...
* [Debug with SSH over tmate](https://github.com/mxschmitt/action-tmate) ⭐ 3,580 | 🐛 36 | 🌐 JavaScript | 📅 2026-07-29 - Debug the Action directly by providing a SSH connection.
* [Paths Filter](https://github.com/dorny/paths-filter) ⭐ 3,321 | 🐛 36 | 🌐 TypeScript | 📅 2026-08-05 - Conditionally run actions based on files modified by PR, feature branch or pushed commits.
...
* [GitHub Actions to compile LaTeX documents](https://github.com/xu-cheng/latex-action) ⭐ 1,410 | 🐛 1 | 🌐 Shell | 📅 2026-07-30
* [Run your job on another architecture: arm32, aarch64 and others](https://github.com/uraimo/run-on-arch-action) ⭐ 751 | 🐛 44 | 🌐 Shell | 📅 2026-08-18
...
* [Import a GPG Key](https://github.com/crazy-max/ghaction-import-gpg) ⭐ 383 | 🐛 25 | 🌐 TypeScript | 📅 2026-09-05
* [Generate a table of contents](https://github.com/technote-space/toc-generator) ⭐ 247 | 🐛 7 | 🌐 TypeScript | 📅 2023-05-09
* [Upload and Scan Files with VirusTotal](https://github.com/crazy-max/ghaction-virustotal) ⭐ 232 | 🐛 29 | 🌐 TypeScript | 📅 2026-09-05
...
* [GitHub Actions Badges for your README](https://github.com/atrox/github-actions-badge) ⭐ 209 | 🐛 5 | 🌐 Go | 📅 2024-01-29
* [Get Latest Tag](https://github.com/WyriHaximus/github-action-get-previous-tag) ⭐ 197 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-08 - Get the previous tag from git.
...
* [Website to GIF](https://github.com/PabloLec/website-to-gif) ⭐ 162 | 🐛 8 | 🌐 Python | 📅 2026-02-12 - Turn any webpage into a GIF to display on your README, docs, etc.
...
* [Wait for commit statuses](https://github.com/WyriHaximus/github-action-wait-for-status) ⭐ 106 | 🐛 54 | 🌐 PHP | 📅 2026-09-09 - Wait until all statuses and checks are successful or any of them has failed and set its status output accordingly.
* [Setup Kubernetes tools](https://github.com/yokawasa/action-setup-kube-tools) ⭐ 95 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-03 - Install Kubernetes tools (kubectl, kustomize, helm, kubeval, conftest, and yq) on the runner.
* [Action to enforce branch naming rules](https://github.com/deepakputhraya/action-branch-name) ⭐ 88 | 🐛 7 | 🌐 JavaScript | 📅 2024-02-12
...
* [Compress with UPX](https://github.com/crazy-max/ghaction-upx) ⭐ 73 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-05 - The Ultimate Packer for eXecutables.
* [Golang CGO cross compiler](https://github.com/crazy-max/ghaction-xgo) ⭐ 70 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-05
* [Automatically add Label or Assignee to an Issue](https://github.com/Naturalclar/issue-action) ⭐ 62 | 🐛 32 | 🌐 TypeScript | 📅 2023-08-14
* [GitHub Actions for Lazarus/FPC](https://github.com/gcarreno/setup-lazarus) ⭐ 58 | 🐛 13 | 🌐 TypeScript | 📅 2026-03-13
...
* [Interactive Inputs - Runtime workflow inputs](https://github.com/boasiHQ/interactive-inputs) ⭐ 50 | 🐛 16 | 🌐 JavaScript | 📅 2026-06-09 - Add dynamic inputs at runtime for your GitHub Actions workflows
...
* [NSFW Detection](https://github.com/fabasoad/nsfw-detection-action) ⭐ 19 | 🐛 1 | 🌐 Shell | 📅 2026-09-09 - Detect NSFW content in committed files.
...
* [Twilio Voice Call](https://github.com/fabasoad/twilio-voice-call-action/) ⭐ 18 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-03 - Make Twilio voice call with defined text.
...
* [Setup Elastic Cloud Control Tool](https://github.com/yokawasa/action-setup-ecctl) ⭐ 4 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-09 - Install a specific version of ecctl on the runner.
...
* [Install NPM Dependencies with Caching](https://github.com/bahmutov/npm-install) ⭐ 673 | 🐛 41 | 🌐 JavaScript | 📅 2026-06-10
* [Cache Yarn Dependencies](https://github.com/c-hive/gha-yarn-cache) ⚠️ Archived
* [Highlight New NPM Dependencies](https://github.com/hiwelo/new-dependencies-action) ⭐ 28 | 🐛 17 | 🌐 TypeScript | 📅 2023-01-06 - Comments on pull requests newly added NPM dependencies information.
...
* [Next SemVers](https://github.com/WyriHaximus/github-action-next-semvers) ⭐ 60 | 🐛 26 | 🌐 PHP | 📅 2026-09-08 - Output the next version for major, minor, and patch version based on the given semver version.
...
* [GraphQL Inspector Action](https://github.com/kamilkisiela/graphql-inspector) ⭐ 1,767 | 🐛 139 | 🌐 TypeScript | 📅 2026-08-20
* [PHPStan Static code analyzer Action](https://github.com/OskarStark/phpstan-ga) ⭐ 101 | 🐛 1 | 🌐 Dockerfile | 📅 2026-09-04
...
* [Run tfsec, with reviewdog output on the PR](https://github.com/reviewdog/action-tfsec) ⭐ 76 | 🐛 7 | 🌐 Shell | 📅 2026-09-07

#### Testing

* [Run Cypress E2E tests](https://github.com/cypress-io/github-action) ⭐ 1,463 | 🐛 45 | 🌐 JavaScript | 📅 2026-09-09
* [Run Unity tests](https://github.com/webbertakken/unity-test-runner) ⭐ 264 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-09
...
* [wemake-python-styleguide - The strictest and most opinionated python linter ever, with optional reviewdog output on the PR](https://github.com/wemake-services/wemake-python-styleguide) ⭐ 2,898 | 🐛 14 | 🌐 Python | 📅 2026-09-09
* [Show and auto-fix linting errors for many programming languages](https://github.com/samuelmeuli/lint-action) ⭐ 608 | 🐛 17 | 🌐 JavaScript | 📅 2026-09-07
* [Lint Pull Request commits with commitlint](https://github.com/wagoid/commitlint-github-action) ⭐ 402 | 🐛 34 | 🌐 JavaScript | 📅 2026-02-14
* [Run dotenv-linter - Lints your .env files like a charm, with optional reviewdog output on the PR](https://github.com/wemake-services/dotenv-linter) ⭐ 304 | 🐛 9 | 🌐 Python | 📅 2026-09-09
* [Run ESLint, with reviewdog output on the PR](https://github.com/reviewdog/action-eslint) ⭐ 260 | 🐛 10 | 🌐 JavaScript | 📅 2026-07-24
* [Run golangci-lint, with reviewdog output on the PR](https://github.com/reviewdog/action-golangci-lint) ⭐ 243 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-09
* [PHP Coding Standards Fixer Action](https://github.com/OskarStark/php-cs-fixer-ga) ⭐ 193 | 🐛 7 | 🌐 Dockerfile | 📅 2026-09-08
* [Run shellcheck, with reviewdog output on the PR](https://github.com/reviewdog/action-shellcheck) ⭐ 121 | 🐛 7 | 🌐 Shell | 📅 2026-08-07
* [Lint terraform files using tflint, with reviewdog output on the PR](https://github.com/reviewdog/action-tflint) ⭐ 119 | 🐛 7 | 🌐 Shell | 📅 2026-09-07
* [Run mispell, with reviewdog output on the PR](https://github.com/reviewdog/action-misspell) ⭐ 102 | 🐛 6 | 🌐 Shell | 📅 2026-09-06
...
* [Run stylelint, with reviewdog output on the PR](https://github.com/reviewdog/action-stylelint) ⭐ 52 | 🐛 3 | 🌐 Shell | 📅 2026-09-05
...
* [Run TSLint with status checks and file diff annotations](https://github.com/mooyoul/tslint-actions) ⭐ 35 | 🐛 31 | 🌐 JavaScript | 📅 2026-09-03
...
* [Stylelint problem matcher to create annotations](https://github.com/xt0rted/stylelint-problem-matcher) ⭐ 18 | 🐛 17 | 🌐 TypeScript | 📅 2026-02-09
...
* [Snyk Test Action](https://github.com/snyk/actions) ⭐ 654 | 🐛 27 | 🌐 HTML | 📅 2026-09-01
...
* [Automatically approve and merge Dependabot updates](https://github.com/ridedott/dependabot-auto-merge-action) ⭐ 316 | 🐛 45 | 🌐 TypeScript | 📅 2026-09-08
...
* [Send your code coverage to codecov.io](https://github.com/codecov/codecov-action) ⭐ 1,709 | 🐛 76 | 🌐 Python | 📅 2026-08-13
...
* [Run Gofmt to check Golang code formatting](https://github.com/Jerome1337/gofmt-action) ⭐ 15 | 🐛 0 | 🌐 Shell | 📅 2022-11-14
* [Run Goimports to check Golang imports order](https://github.com/Jerome1337/goimports-action) ⭐ 6 | 🐛 1 | 🌐 Shell | 📅 2020-07-22
...
* [Size Limit Action](https://github.com/andresz1/size-limit-action) ⭐ 473 | 🐛 49 | 🌐 TypeScript | 📅 2024-06-07 - Comments cost comparison of your JS in PRs and rejects them if limit is exceeded.
...
* [Create a PR for Changes to your Repository in the Actions Workspace](https://github.com/peter-evans/create-pull-request) ⭐ 2,847 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-03
* [Automatically merge PRs That Are Ready](https://github.com/pascalgn/automerge-action) ⭐ 926 | 🐛 41 | 🌐 JavaScript | 📅 2024-09-22
...
* [Auto-Approve PRs](https://github.com/hmarr/auto-approve-action) ⭐ 478 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-30
* [Pull Request Stats](https://github.com/flowwer-dev/pull-request-stats) ⭐ 406 | 🐛 6 | 🌐 JavaScript | 📅 2026-03-14 -  Print relevant stats about reviewers.
* [Automatically add Reviewers to PR based on the Configuration File](https://github.com/kentaro-m/auto-assign-action) ⭐ 403 | 🐛 47 | 🌐 TypeScript | 📅 2026-09-04
...
* [Open or Update PR on Branch Push (with Branch Selection)](https://github.com/vsoch/pull-request-action) ⭐ 174 | 🐛 0 | 🌐 Python | 📅 2025-04-23
...
* [Pull Request Lint With Regex](https://github.com/MorrisonCole/pr-lint-action) ⭐ 72 | 🐛 28 | 🌐 JavaScript | 📅 2026-09-07
...
* [GitHub Actions for deploying to GitHub Pages with Static Site Generators](https://github.com/peaceiris/actions-gh-pages) ⭐ 5,359 | 🐛 95 | 🌐 TypeScript | 📅 2026-09-07
...
* [Deploy to GitHub Pages with Advanced Settings](https://github.com/crazy-max/ghaction-github-pages) ⭐ 521 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-08
* [Deploy a Zola site to GitHub Pages](https://github.com/shalzz/zola-deploy-action) ⭐ 291 | 🐛 2 | 🌐 HTML | 📅 2026-08-21
...
* [Deploy Google Analytics stats to GitHub Pages](https://github.com/cristianpb/analytics-google) ⭐ 16 | 🐛 2 | 🌐 Svelte | 📅 2026-09-08
...
* [Send an Embed Message to Discord](https://github.com/sarisia/actions-status-discord) ⭐ 278 | 🐛 11 | 🌐 TypeScript | 📅 2026-05-08
...
* [Send Microsoft Teams Notification](https://github.com/opsless/ms-teams-github-actions) ⭐ 38 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-07
...
* [Watch for GitHub Wiki page changes and post to Slack](https://github.com/benmatselby/gollum-page-watcher-action) ⭐ 17 | 🐛 0 | 🌐 Go | 📅 2026-09-04
...
* [Executing remote ssh commands](https://github.com/appleboy/ssh-action) ⭐ 6,194 | 🐛 32 | 🌐 Shell | 📅 2026-08-16
* [FTP Deploy Action, Deploys a GitHub project to a FTP server using GitHub actions](https://github.com/SamKirkland/FTP-Deploy-Action) ⭐ 5,203 | 🐛 149 | 🌐 TypeScript | 📅 2026-04-23
* [Copy files and artifacts via SSH](https://github.com/appleboy/scp-action) ⭐ 1,578 | 🐛 88 | 🌐 Shell | 📅 2026-08-09
* [Publish a Python distribution package to PyPI](https://github.com/pypa/gh-action-pypi-publish) ⭐ 1,183 | 🐛 32 | 🌐 Python | 📅 2026-07-29
* [GitHub Action for GoReleaser, a release automation tool for Go projects](https://github.com/goreleaser/goreleaser-action) ⭐ 1,033 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-03
* [Build and publish Electron apps](https://github.com/samuelmeuli/action-electron-builder) ⚠️ Archived
* [Action For Semantic Release](https://github.com/cycjimmy/semantic-release-action) ⭐ 703 | 🐛 47 | 🌐 JavaScript | 📅 2026-08-10
* [Build and deploy a theme to Ghost CMS](https://github.com/TryGhost/action-deploy-theme) ⭐ 391 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-07
* [Serialize Workflow Runs in Continuous Deployment Pipelines](https://github.com/softprops/turnstyle) ⭐ 381 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-07
* [Deploy to Netlify](https://github.com/netlify/actions) ⭐ 377 | 🐛 30 | 🌐 Shell | 📅 2025-12-15
* [Netlify Deploy GitHub Action for each commit](https://github.com/nwtgck/actions-netlify) ⭐ 355 | 🐛 53 | 🌐 TypeScript | 📅 2026-09-07
...
* [Deploy a Collection to Ansible Galaxy](https://github.com/artis3n/ansible_galaxy_collection) ⭐ 134 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-09
...
* [Trigger multiple Jenkins Jobs](https://github.com/appleboy/jenkins-action) ⭐ 95 | 🐛 0 | 🌐 Dockerfile | 📅 2026-08-09
...
* [Cross platform Chocolatey CLI to build and publish packages](https://github.com/crazy-max/ghaction-chocolatey) ⭐ 79 | 🐛 16 | 🌐 Dockerfile | 📅 2026-09-03
* [Trigger multiple GitLab CI Pipeline](https://github.com/appleboy/gitlab-ci-action) ⭐ 64 | 🐛 3 | 🌐 Dockerfile | 📅 2026-07-18
* [Run Ansible Playbooks](https://github.com/arillso/action.playbook) ⭐ 38 | 🐛 1 | 🌐 Go | 📅 2026-09-09
...
* [Deploy with AWS CodeDeploy](https://github.com/webfactory/create-aws-codedeploy-deployment) ⭐ 21 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-21
...
* [Update a Docker Hub repository description from README.md](https://github.com/peter-evans/dockerhub-description) ⭐ 383 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-03
* [Build And Push Your Docker Images Caching Each Stage To Reduce Build Time](https://github.com/whoan/docker-build-with-cache-action) ⭐ 350 | 🐛 0 | 🌐 Shell | 📅 2026-09-07
* [Set up Docker Buildx](https://github.com/crazy-max/ghaction-docker-buildx) ⚠️ Archived
* [Monitor and limit your docker image size](https://github.com/wemake-services/docker-image-size-limit) ⭐ 133 | 🐛 1 | 🌐 Python | 📅 2026-09-07
...
* [Deploy to any Cloud or Kubernetes Using Pulumi](https://github.com/pulumi/actions) ⭐ 291 | 🐛 76 | 🌐 TypeScript | 📅 2026-09-09
...
* [GitHub Action for Firebase](https://github.com/w9jds/firebase-action) ⭐ 949 | 🐛 40 | 🌐 Shell | 📅 2026-09-03
* [GitHub Action for Google Cloud Platform (GCP)](https://github.com/exelban/gcloud) ⭐ 242 | 🐛 2 | 🌐 Shell | 📅 2026-09-01
...
* [run-vcpkg](https://github.com/lukka/run-vcpkg) ⭐ 234 | 🐛 25 | 🌐 TypeScript | 📅 2026-09-09 - Multi platform action to build and install C/C++ dependencies with [vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,451 | 🐛 1,202 | 🌐 CMake | 📅 2026-09-09.
* [run-cmake](https://github.com/lukka/run-cmake) ⭐ 196 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-07 - Multi platform action to build C/C++ software with [CMake](https://cmake.org) and [Ninja](https://ninja-build.org/).
...
* [Run Pascal Script](https://github.com/fabasoad/pascal-action) ⭐ 12 | 🐛 0 | 🌐 Pascal | 📅 2026-08-07
...
* [Translation](https://github.com/fabasoad/translation-action) ⭐ 52 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-05 - Translate text from any language to any language.
