...
* [Official Actions organization](https://github.com/actions)
  * [actions/virtual-environments](https://github.com/actions/virtual-environments) ⭐ 13,013 | 🐛 134 | 🌐 PowerShell | 📅 2026-08-12 - GitHub Actions virtual environments.
  * [actions/runner](https://github.com/actions/runner) ⭐ 6,186 | 🐛 530 | 🌐 C# | 📅 2026-08-12 - The Runner for GitHub Actions.
* [GitHub Blog Announcement](https://github.blog/2018-10-17-action-demos/)

### Workflow Examples

* [actions/starter-workflows](https://github.com/actions/starter-workflows) ⭐ 11,935 | 🐛 499 | 🌐 TypeScript | 📅 2026-08-03 - Starter workflow management.
...
* [actions/checkout](https://github.com/actions/checkout) ⭐ 8,638 | 🐛 686 | 🌐 TypeScript | 📅 2026-08-10 - Setup your repository on your workflow.
* [actions/cache](https://github.com/actions/cache) ⭐ 5,510 | 🐛 237 | 🌐 TypeScript | 📅 2026-07-15 - Cache dependencies and build outputs in GitHub Actions.
* [actions/github-script](https://github.com/actions/github-script) ⭐ 5,004 | 🐛 92 | 🌐 TypeScript | 📅 2026-04-09 - Write a script for GitHub API and the workflow contexts.
* [actions/upload-artifact](https://github.com/actions/upload-artifact) ⭐ 4,165 | 🐛 262 | 🌐 TypeScript | 📅 2026-04-14 - Upload artifacts from your workflow.
* [actions/download-artifact](https://github.com/actions/download-artifact) ⭐ 1,881 | 🐛 154 | 🌐 TypeScript | 📅 2026-03-18 - Download artifacts from your build.

#### Actions for GitHub Automation

Automate management for issues, pull requests, and releases.

* [actions/labeler](https://github.com/actions/labeler) ⭐ 2,487 | 🐛 64 | 🌐 TypeScript | 📅 2026-08-10 - An action for automatically labelling pull requests.
* [actions/stale](https://github.com/actions/stale) ⭐ 1,702 | 🐛 94 | 🌐 TypeScript | 📅 2026-08-07 - Marks issues and pull requests that have not had recent interaction.
...
* [actions/first-interaction](https://github.com/actions/first-interaction) ⭐ 887 | 🐛 27 | 🌐 TypeScript | 📅 2026-01-21 - An action for filtering pull requests and issues from first-time contributors.
...
* [actions/setup-node: Node.js](https://github.com/actions/setup-node) ⭐ 4,933 | 🐛 84 | 🌐 TypeScript | 📅 2026-08-11
* [actions/setup-python: Python](https://github.com/actions/setup-python) ⭐ 2,197 | 🐛 60 | 🌐 TypeScript | 📅 2026-08-05
* [actions/setup-java: Java](https://github.com/actions/setup-java) ⭐ 1,980 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-10
* [actions/setup-go: Go](https://github.com/actions/setup-go) ⭐ 1,747 | 🐛 54 | 🌐 TypeScript | 📅 2026-08-05
* [actions/setup-dotnet: .NET core sdk](https://github.com/actions/setup-dotnet) ⭐ 1,198 | 🐛 39 | 🌐 TypeScript | 📅 2026-08-10
...
* [actions/setup-julia: Julia](https://github.com/julia-actions/setup-julia) ⭐ 107 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-01
...
* [actions/toolkit](https://github.com/actions/toolkit) ⭐ 5,821 | 🐛 580 | 🌐 TypeScript | 📅 2026-08-05 - The GitHub ToolKit for developing GitHub Actions.
...
* [Run GitHub Actions Locally in Terminal](https://github.com/nektos/act) ⭐ 71,493 | 🐛 360 | 🌐 Go | 📅 2026-08-09
* [Publish GitHub Releases with Assets](https://github.com/softprops/action-gh-release) ⭐ 5,733 | 🐛 115 | 🌐 TypeScript | 📅 2026-08-09
...
* [Create Issue Branch](https://github.com/robvanderleek/create-issue-branch) ⭐ 351 | 🐛 12 | 🌐 JavaScript | 📅 2026-08-13
...
* [Lock Closed Issues and Pull Requests after a Period of Inactivity](https://github.com/dessant/lock-threads) ⭐ 333 | 🐛 4 | 🌐 JavaScript | 📅 2026-06-26
...
* [Generate Release Notes Based on Git References](https://github.com/metcalfc/changelog-generator) ⭐ 149 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-10
...
* [GitHub Actions for PHP](https://github.com/shivammathur/setup-php) ⭐ 3,249 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-12
...
* [GitHub Actions for Unity](https://github.com/webbertakken/unity-actions) ⭐ 1,093 | 🐛 0 | 🌐 Mathematica | 📅 2023-03-04
* [GitHub Actions for WordPress](https://github.com/10up/actions-wordpress/) ⭐ 463 | 🐛 5 | 🌐 Shell | 📅 2025-10-09
* [GitHub Actions for Yarn 1](https://github.com/Borales/actions-yarn) ⭐ 315 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-11
...
* [GitHub Actions for AWS](https://github.com/clowdhaus/aws-github-actions) ⭐ 122 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-09
* [Octions - GitHub Actions for GitHub REST API](https://github.com/maxkomarychev/octions) ⭐ 42 | 🐛 17 | 🌐 JavaScript | 📅 2023-01-05
...
* [Debug with SSH over tmate](https://github.com/mxschmitt/action-tmate) ⭐ 3,574 | 🐛 36 | 🌐 JavaScript | 📅 2026-07-29 - Debug the Action directly by providing a SSH connection.
* [Paths Filter](https://github.com/dorny/paths-filter) ⭐ 3,284 | 🐛 36 | 🌐 TypeScript | 📅 2026-08-05 - Conditionally run actions based on files modified by PR, feature branch or pushed commits.
...
* [GitHub Actions to compile LaTeX documents](https://github.com/xu-cheng/latex-action) ⭐ 1,407 | 🐛 1 | 🌐 Shell | 📅 2026-07-30
...
* [Setup Xcode](https://github.com/maxim-lobanov/setup-xcode) ⭐ 392 | 🐛 15 | 🌐 TypeScript | 📅 2026-03-18 - Switch between pre-installed versions of Xcode for macOS images.
...
* [Get Latest Tag](https://github.com/WyriHaximus/github-action-get-previous-tag) ⭐ 196 | 🐛 10 | 🌐 JavaScript | 📅 2026-07-20 - Get the previous tag from git.
...
* [Website to GIF](https://github.com/PabloLec/website-to-gif) ⭐ 160 | 🐛 8 | 🌐 Python | 📅 2026-02-12 - Turn any webpage into a GIF to display on your README, docs, etc.
...
* [Wait for commit statuses](https://github.com/WyriHaximus/github-action-wait-for-status) ⭐ 106 | 🐛 55 | 🌐 PHP | 📅 2026-08-12 - Wait until all statuses and checks are successful or any of them has failed and set its status output accordingly.
* [Setup Kubernetes tools](https://github.com/yokawasa/action-setup-kube-tools) ⭐ 94 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-07 - Install Kubernetes tools (kubectl, kustomize, helm, kubeval, conftest, and yq) on the runner.
...
* [Golang CGO cross compiler](https://github.com/crazy-max/ghaction-xgo) ⭐ 70 | 🐛 20 | 🌐 TypeScript | 📅 2026-08-12
...
* [Interactive Inputs - Runtime workflow inputs](https://github.com/boasiHQ/interactive-inputs) ⭐ 48 | 🐛 16 | 🌐 JavaScript | 📅 2026-06-09 - Add dynamic inputs at runtime for your GitHub Actions workflows
...
* [Twilio Voice Call](https://github.com/fabasoad/twilio-voice-call-action/) ⭐ 18 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-07 - Make Twilio voice call with defined text.
...
* [GraphQL Inspector Action](https://github.com/kamilkisiela/graphql-inspector) ⭐ 1,757 | 🐛 138 | 🌐 TypeScript | 📅 2026-06-17
...
* [Run tfsec, with reviewdog output on the PR](https://github.com/reviewdog/action-tfsec) ⭐ 76 | 🐛 7 | 🌐 Shell | 📅 2026-08-12

#### Testing

* [Run Cypress E2E tests](https://github.com/cypress-io/github-action) ⭐ 1,461 | 🐛 39 | 🌐 JavaScript | 📅 2026-08-13
* [Run Unity tests](https://github.com/webbertakken/unity-test-runner) ⭐ 260 | 🐛 42 | 🌐 TypeScript | 📅 2026-08-13
...
* [wemake-python-styleguide - The strictest and most opinionated python linter ever, with optional reviewdog output on the PR](https://github.com/wemake-services/wemake-python-styleguide) ⭐ 2,890 | 🐛 22 | 🌐 Python | 📅 2026-08-13
...
* [Run dotenv-linter - Lints your .env files like a charm, with optional reviewdog output on the PR](https://github.com/wemake-services/dotenv-linter) ⭐ 305 | 🐛 9 | 🌐 Python | 📅 2026-08-13
* [Run ESLint, with reviewdog output on the PR](https://github.com/reviewdog/action-eslint) ⭐ 260 | 🐛 10 | 🌐 JavaScript | 📅 2026-07-24
* [Run golangci-lint, with reviewdog output on the PR](https://github.com/reviewdog/action-golangci-lint) ⭐ 243 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-07
...
* [Run TSLint with status checks and file diff annotations](https://github.com/mooyoul/tslint-actions) ⭐ 34 | 🐛 30 | 🌐 JavaScript | 📅 2026-08-11
...
* [Send your code coverage to codecov.io](https://github.com/codecov/codecov-action) ⭐ 1,700 | 🐛 75 | 🌐 Python | 📅 2026-08-13
...
* [Create a PR for Changes to your Repository in the Actions Workspace](https://github.com/peter-evans/create-pull-request) ⭐ 2,831 | 🐛 20 | 🌐 TypeScript | 📅 2026-08-01
* [Automatically merge PRs That Are Ready](https://github.com/pascalgn/automerge-action) ⭐ 924 | 🐛 41 | 🌐 JavaScript | 📅 2024-09-22
* [Automatically Bump and Tag on Merge](https://github.com/anothrNick/github-tag-action) ⭐ 878 | 🐛 41 | 🌐 Shell | 📅 2025-08-22
* [Automatically Rebase a PR](https://github.com/cirrus-actions/rebase) ⚠️ Archived
* [Auto-Approve PRs](https://github.com/hmarr/auto-approve-action) ⭐ 476 | 🐛 13 | 🌐 TypeScript | 📅 2024-04-04
...
* [Pull Request Lint With Regex](https://github.com/MorrisonCole/pr-lint-action) ⭐ 72 | 🐛 28 | 🌐 JavaScript | 📅 2026-08-12
...
* [GitHub Actions for deploying to GitHub Pages with Static Site Generators](https://github.com/peaceiris/actions-gh-pages) ⭐ 5,352 | 🐛 93 | 🌐 TypeScript | 📅 2026-08-12
...
* [Deploy to GitHub Pages with Advanced Settings](https://github.com/crazy-max/ghaction-github-pages) ⭐ 516 | 🐛 15 | 🌐 TypeScript | 📅 2026-08-12
...
* [Deploy Google Analytics stats to GitHub Pages](https://github.com/cristianpb/analytics-google) ⭐ 16 | 🐛 2 | 🌐 Svelte | 📅 2026-08-12
* [Google Dataset Search Metadata](https://www.github.com/openschemas/extractors/) - And other schema.org extractors to make datasets discoverable from GitHub pages.

### Notifications and Messages

* [Send a Telegram Message](https://github.com/appleboy/telegram-action) ⭐ 1,018 | 🐛 32 | 🌐 Dockerfile | 📅 2026-08-09
* [Send a Discord notification](https://github.com/Ilshidur/action-discord) ⭐ 463 | 🐛 36 | 🌐 JavaScript | 📅 2026-07-26
...
* [Executing remote ssh commands](https://github.com/appleboy/ssh-action) ⭐ 6,171 | 🐛 33 | 🌐 Shell | 📅 2026-07-18
* [FTP Deploy Action, Deploys a GitHub project to a FTP server using GitHub actions](https://github.com/SamKirkland/FTP-Deploy-Action) ⭐ 5,171 | 🐛 149 | 🌐 TypeScript | 📅 2026-04-23
* [Copy files and artifacts via SSH](https://github.com/appleboy/scp-action) ⭐ 1,574 | 🐛 89 | 🌐 Shell | 📅 2026-08-09
* [Publish a Python distribution package to PyPI](https://github.com/pypa/gh-action-pypi-publish) ⭐ 1,179 | 🐛 31 | 🌐 Python | 📅 2026-07-29
* [GitHub Action for GoReleaser, a release automation tool for Go projects](https://github.com/goreleaser/goreleaser-action) ⭐ 1,026 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-05
* [Build and publish Electron apps](https://github.com/samuelmeuli/action-electron-builder) ⚠️ Archived
* [Action For Semantic Release](https://github.com/cycjimmy/semantic-release-action) ⭐ 697 | 🐛 47 | 🌐 JavaScript | 📅 2026-08-10
* [Build and deploy a theme to Ghost CMS](https://github.com/TryGhost/action-deploy-theme) ⭐ 391 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-12
...
* [Netlify Deploy GitHub Action for each commit](https://github.com/nwtgck/actions-netlify) ⭐ 355 | 🐛 51 | 🌐 TypeScript | 📅 2026-08-11
...
* [Deploy a Collection to Ansible Galaxy](https://github.com/artis3n/ansible_galaxy_collection) ⭐ 133 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-12
...
* [Run Ansible Playbooks](https://github.com/arillso/action.playbook) ⭐ 37 | 🐛 2 | 🌐 Go | 📅 2026-08-12
...
* [Build And Push Your Docker Images Caching Each Stage To Reduce Build Time](https://github.com/whoan/docker-build-with-cache-action) ⭐ 350 | 🐛 0 | 🌐 Shell | 📅 2026-08-08
* [Set up Docker Buildx](https://github.com/crazy-max/ghaction-docker-buildx) ⚠️ Archived
* [Monitor and limit your docker image size](https://github.com/wemake-services/docker-image-size-limit) ⭐ 133 | 🐛 1 | 🌐 Python | 📅 2026-08-11
...
* [Deploy to any Cloud or Kubernetes Using Pulumi](https://github.com/pulumi/actions) ⭐ 291 | 🐛 80 | 🌐 TypeScript | 📅 2026-08-11
...
* [GitHub Action for Firebase](https://github.com/w9jds/firebase-action) ⭐ 947 | 🐛 40 | 🌐 Shell | 📅 2026-08-06
* [GitHub Action for Google Cloud Platform (GCP)](https://github.com/exelban/gcloud) ⭐ 241 | 🐛 2 | 🌐 Shell | 📅 2026-08-12
...
* [run-vcpkg](https://github.com/lukka/run-vcpkg) ⭐ 233 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-03 - Multi platform action to build and install C/C++ dependencies with [vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,353 | 🐛 1,161 | 🌐 CMake | 📅 2026-08-13.
* [run-cmake](https://github.com/lukka/run-cmake) ⭐ 195 | 🐛 16 | 🌐 TypeScript | 📅 2026-08-10 - Multi platform action to build C/C++ software with [CMake](https://cmake.org) and [Ninja](https://ninja-build.org/).
...
* [Translation](https://github.com/fabasoad/translation-action) ⭐ 51 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-07 - Translate text from any language to any language.
